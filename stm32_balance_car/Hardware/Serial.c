...
void Serial_Init(void)
{
	...
	USART_InitStructure.USART_BaudRate = 115200;            //波特率，与视觉串口共用USART1，统一为115200
...
/**
  * 注意事项：USART1的接收中断已由视觉模块（Vision.c）接管，中断函数定义在Vision.c中
  *           本文件的Serial_RxData和Serial_RxFlag现已不再更新
  */
